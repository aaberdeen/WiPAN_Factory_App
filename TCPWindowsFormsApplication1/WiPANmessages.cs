...
namespace WiPANFactory
{
    ...
    class WipanCmd
    {
        ...
        public static byte getTypeLength(WiPANmessages.dataType type)
        {
            switch(type)
            {
                ...
                case WiPANmessages.dataType.SYSTEM_WATCHDOG:
                  return 0x0;
                //case WiPANmessages.dataType.CLOSE_UDP:
                //  return 0x0;
                //case WiPANmessages.dataType.OPEN_UDP:
                //  return 0x0;
        ...
        public static byte[] openUDP()
        {
            byte[] data2 = {(byte)WiPANmessages.messageType.UDP_CONFIG,
                               (byte)WiPANmessages.dataType.OPEN_UDP,
                               getTypeLength(WiPANmessages.dataType.OPEN_UDP)};

            return data2;
        }

        public static byte[] closeUDP()
        {
            byte[] data2 = {(byte)WiPANmessages.messageType.UDP_CONFIG,
                               (byte)WiPANmessages.dataType.CLOSE_UDP,
                               getTypeLength(WiPANmessages.dataType.CLOSE_UDP)};
